...
class SingleResultDescriptor(pydantic.BaseModel):
    ...
    def report_success(self, cui: str, name: str, finding: Finding, fail_reason: Optional[FailDescriptor]) -> None:
        ...
        # TODO - do I do something with the fail reason?
...
class ResultDescriptor(SingleResultDescriptor):
    ...
    def report(self, cui: str, name: str, phrase: str, finding: Finding, fail_reason: Optional[FailDescriptor]) -> None:
        """Report a test case and its successfulness
        ...
        Args:
            ...
            fail_reason (Optional[FailDescriptor]): The reason for the failure (if applicable)
        """
        super().report_success(cui, name, finding, fail_reason)
