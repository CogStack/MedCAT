...
class RelData(Dataset):
    ...
    def __init__(self, tokenizer: TokenizerWrapperBERT | TokenizerWrapperLlama | TokenizerWrapperModernBERT, config: ConfigRelCAT, cdb: CDB = CDB()):
        ...
        Args:
            tokenizer (TokenizerWrapperBERT | TokenizerWrapperLlama | TokenizerWrapperModernBERT): 
        ...
        self.tokenizer: TokenizerWrapperBERT | TokenizerWrapperLlama | TokenizerWrapperModernBERT = tokenizer
